...
class OrderSystem:
    ...
    def populate_products(self):
        ...
        beverages.add_product(Product("Sprite/Stone Ginger 2 Litres", 37.99, "Soft drink"))
        beverages.add_product(Product("Pepsi/Mirinda (500ml x 24)", 178.99, "Soft drink pack"))
        beverages.add_product(Product("Probands/Dairibord Steri Milk 500ml", 20.99, "Steri milk"))
        ...
        personal_care.add_product(Product("Softex / Lulu / Wish Toilet Tissue 1-Ply 4s", 39.99, "Toilet tissue"))
        ...
        personal_care.add_product(Product("Kiwi/Nugget Black Shoe Polish 50ml", 18.99, "Shoe polish"))
        ...
        snacks.add_product(Product("Willards Things/Cheezies/Jupiters 150g", 14.99, "Cheese snacks"))
        snacks.add_product(Product("Stumbo/Yogueta Assorted Lollipops 48s", 59.99, "Lollipops"))
        snacks.add_product(Product("Pringles Original 110g", 22.90, "Potato chips"))
        snacks.add_product(Product("Nibble Naks/Jumbo Naks 20pack", 29.99, "Snacks"))
        ...
        fresh.add_product(Product("Parmalat/Clover/PnP 12 Slices Cheddar Cheese", 89.99, "Cheddar cheese slices"))
        ...
        fresh.add_product(Product("Irvine's/Big Brother/Sable Mixed Chicken Cuts 2kg", 179.99, "Mixed chicken cuts"))
